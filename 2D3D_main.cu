...
__global__ void cosine10_2__6_6_5(double *B_d, double *radius_d)
{
	int threads_per_block = blockDim.x * blockDim.y * blockDim.z;
	int threads_count_before_current_block = (threads_per_block * gridDim.x * blockIdx.y) + threads_per_block * blockIdx.x;
...
int main()
{
	...
	outputfile = fopen("./outputs/cosine10_2__6_6_5.txt", "w"); 
	if (outputfile == NULL) {
	...
	cosine10_2__6_6_5<<< blocks, threads >>>(B_d, radius_d);
