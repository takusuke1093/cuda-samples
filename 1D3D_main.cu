...
__global__ void cosine10_1__6_6_10(double *B_d, double *radius_d)
{
	int threads_count_before_current_block = (blockDim.x * blockDim.y * blockDim.z) * blockIdx.x;
...
int main()
{
	...
	outputfile = fopen("./outputs/cosine10_1__6_6_10.txt", "w"); 
	if (outputfile == NULL) {
	...
	cosine10_1__6_6_10<<< blocks, threads >>>(B_d, radius_d);
