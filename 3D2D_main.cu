...
__global__ void cosine6_6_10__5_2_1(double *B_d, double *radius_d)
{
...
int main()
{
	...
	outputfile = fopen("./outputs/cosine6_6_10__5_2_1.txt", "w"); 
	if (outputfile == NULL) {
	...
	cosine6_6_10__5_2_1<<< blocks, threads >>>(B_d, radius_d);
